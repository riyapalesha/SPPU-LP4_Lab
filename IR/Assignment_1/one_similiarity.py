...
# translation_table is a translation table created using str.maketrans. It is used to translate punctuation and uppercase letters to spaces, effectively removing punctuation and converting uppercase letters to lowercase.
